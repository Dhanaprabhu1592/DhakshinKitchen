...
import com.whistledevelopers.dhakshinkitchen.model.ConfirmItemModel;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemViewHolder> implements Filterable{
    ...
    public void onBindViewHolder(@NonNull final ItemViewHolder holder, final int position) {
        ...
        if (model.getQuantity() > 0) {
            OrderActivity.text_message.setVisibility(View.GONE);
            holder.text_name.setText(model.getName());
            holder.txt_qty.setText(model.getCount());
            holder.text_count.setText(String.valueOf(model.getQuantity()));
